...
public class FaceIdService {
    ...
    private CascadeClassifier loadCascadeFromJar() throws Exception {
        InputStream is = getClass().getResourceAsStream("/userManagement/haarcascade_frontalface_default.xml");
        if (is == null) {
                    ...
                    try {
                        ...
                        if (conn instanceof java.net.JarURLConnection jc) {
                            ...
                            while (entries.hasMoreElements()) {
                                ...
                                if (name.endsWith("userManagement/haarcascade_frontalface_default.xml")) {
        ...
        try {
            ProcessBuilder pb = new ProcessBuilder(
                    ...
                    "import cv2, os; print(os.path.join(os.path.dirname(cv2.__file__)," +
                            " 'data', 'userManagement/haarcascade_frontalface_default.xml'))"
            );
    ...
    private void initCascade() throws Exception {
        ...
        InputStream in = getClass().getResourceAsStream(
                "/userManagement/haarcascade_frontalface_default.xml");
        if (in == null) {
            // Fall back to OpenCV's bundled path
            faceDetector = new CascadeClassifier();
            if (!faceDetector.load("userManagement/haarcascade_frontalface_default.xml")) {
