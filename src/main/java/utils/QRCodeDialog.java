...
public class QRCodeDialog {
    ...
    public void showShareableTeamQrWithCustomIp(Equipe equipeRef, Stage ownerStage, String customIp) {
        try {
            ...
            String localIpAddress = (customIp != null) ? customIp : utils.TeamWebServer.getLocalIp();
            ...
            String coach = (equipe.getCoach() != null && equipe.getCoach() != null)
            ...
            changeIpBtn.setOnAction(ev -> {
                ...
                diag.showAndWait().ifPresent(newIp -> {
                    ...
                    currentStage.close();
                    showShareableTeamQrWithCustomIp(finalEquipe, ownerStage, newIp);
                });
            });
    ...
    private VBox buildTeamDetailsVBox(Equipe equipe, List<Player> players) {
        ...
        String coachName = (equipe.getCoach() != null && equipe.getCoach() != null)
