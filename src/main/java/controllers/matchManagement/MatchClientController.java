...
public class MatchClientController {
    ...
    private void showPredictionDialog(Matchs m) {
        PredictionService.PredictionResult result = predictionService.predictWinner(m);
    ...
    public void openSimulatorDialog(ActionEvent event) {
        ...
        predictBtn.setOnAction(e -> {
            ...
            PredictionService.PredictionResult res = predictionService.predictWinner(eq1, eq2);
...
//    }
    ...
    public void goEquipes(ActionEvent event) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/matchManagement/equipeIndex_client.fxml")
            );
    ...
    public void goStats(ActionEvent event) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/matchManagement/stats_client.fxml")
            );
