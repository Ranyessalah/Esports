...
//    }
    ...
    private void goMatchs(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(this.getClass().getResource("/matchManagement/matchIndex_client.fxml"));
            Parent root = loader.load();
    ...
    private void goStats(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(this.getClass().getResource("/matchManagement/stats_client.fxml"));
            Parent root = loader.load();
            Stage stage = (Stage)((Node)event.getSource()).getScene().getWindow();
            stage.setScene(new Scene(root, 1200.0, 760.0));
            stage.show();
