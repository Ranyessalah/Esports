...
public class MainLayoutController implements Initializable {
    ...
    public void onProfileClick() {
        ...
        User user = prefs.loadSession();
        if (user == null) return;

        String fxml;
        switch (user.getRole()) {
            case ROLE_COACH  -> fxml = "/userManagement/CoachProfile.fxml";
            case ROLE_PLAYER -> fxml = "/userManagement/PlayerProfile.fxml";
        ...
        try {
            ...
            if (user.getRole() == Roles.ROLE_COACH) {
                CoachProfileController ctrl = loader.getController();
                ctrl.setUser(user);
            } else {
