...
public class OtpVerificationController implements Initializable {
    ...
    private void onBack() {
        if (countdownTimer != null) countdownTimer.stop();
        navigateTo("/userManagement/ForgotPassword.fxml", "ClutchX — Réinitialisation");
    }
    ...
    private void navigateToReset(String email, String otp) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/userManagement/ResetPassword.fxml"));
